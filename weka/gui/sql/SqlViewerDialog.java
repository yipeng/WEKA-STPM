...
public class SqlViewerDialog 
  ...
  protected void createDialog() {
    ...
    //final Container dialog = getContentPane();
    dialog = this;
  ...
  private void m_ButtonOKActionPerformed(ActionEvent evt) {
	  m_ReturnValue = JOptionPane.OK_OPTION;
      // remove listener, otherwise does the disposal of resultspanel
      // change the query again!
      m_Viewer.removeResultChangedListener(this);
      m_Viewer.saveSize();
      this.dispose();
  }
  private void m_ButtonCancelActionPerformed(ActionEvent evt) {
