...
//GDPM+STDPM alterations
import weka.gui.gdpm.GeographicData;
...
public class ConnectionPanel 
  ...
  //GDPM +STDPM modifications
  protected JButton m_GDPM = new JButton("Geographic Data");
  
  protected JButton m_STDPM = new JButton("Trajectory Data");
  ...
  protected void createPanel() {
    ...
    m_GDPM.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent e) {	
    		GDPMActionPerformed(e);
    	}
    			});
    panel.add(m_GDPM);    
    m_STDPM.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {	
        	STDPMActionPerformed(e);        	
        }
            	});
    panel.add(m_STDPM);
  ...
  private void STDPMActionPerformed(ActionEvent e) {
	  //this.setEnabled(false);
	  //super.setVisible(false);
	  TrajectoryFrame t = new TrajectoryFrame(getUser(),getPassword(),getURL());	
      //super.setVisible(true);
      //this.setEnabled(true);
  }
  
  private void GDPMActionPerformed(ActionEvent e){
	  this.setEnabled(false);
	  try{
      	GeographicData sp = new GeographicData(getUser(),getPassword(),getURL());
      	sp.setVisible(true);        	
      	//sp.setFocusableWindowState(true);
      	setButtons();        	
      }catch(Exception e1){}
      finally{
    	  this.setEnabled(false);
